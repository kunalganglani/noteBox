commentBox = (function () {
    ...
    return {
        ...
        createTemplate(comment) {
            ...
            tmpl.querySelector('.timeStampStyle').innerText = this.prettyDate(comment.updated_at);
        ...
        addChilds(parentObj, childs) {
            for (var i = 0; i < childs.length; i++) {
                ...
                if (comment.children.length != 0) {
                    this.addChilds(y, comment.children)
                }
            }
